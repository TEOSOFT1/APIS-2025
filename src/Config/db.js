...
// Citas y Servicios
db.AgendamientoCita.belongsToMany(db.Servicio, { through: db.CitaServicio, foreignKey: "IdCita", otherKey: "IdServicio" });
db.Servicio.belongsToMany(db.AgendamientoCita, { through: db.CitaServicio, foreignKey: "IdServicio", otherKey: "IdCita" });
